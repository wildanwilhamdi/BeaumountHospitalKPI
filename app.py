...
def init_db_connection():
    ...
    return client["beaumont_db"]["kpi_trends"]
...
# --- STYLING CUSTOM CSS (Opsional agar mirip web sebelumnya) ---
st.markdown("""
    <style>
...
# --- KUADRAN 1 & 2: HEADER & KONTROL ---
st.markdown("<h1 style='color: #20c997;'>Beaumont Hospital</h1>", unsafe_allow_html=True)
st.markdown("This dashboard presents a detailed analysis of operational and clinical Key Performance Indicators (KPIs). It highlights comparisons against national averages, regional benchmarks, and monthly performance trends to support data-driven decision making.")
...
# --- KUADRAN 3 & 4: LAYOUT KIRI KANAN ---
col_left, col_right = st.columns(2)

# Kuadran 3: Tabel Metrik 2x2 & Chart Comparison
with col_left:
    # Baris 1: Value & Target
    c1, c2 = st.columns(2)
    with c1:
    ...
    # Chart Comparison (Hospital vs National)
...
# Kuadran 4: Chart Trend Memanjang ke Bawah
with col_right:
